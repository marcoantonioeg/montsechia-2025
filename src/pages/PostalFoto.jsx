...
import InstaxFlor from '../../public/images/Instax_Flor.png'
import InstaxFoto from '../../public/images/Instax_Personas.png'
...
const PostalFoto = () => {
  ...
  const handleImageUpload = async (e) => {
    ...
    try {
      ...
      // Agregar la imagen al carrito
      addToCart({
        fotoId: data.public_id,
        imageUrl: data.url
      });
    ...
    setTimeout(() => {
      navigate('/excelentes-decisiones');
    }, 1000);
  ...
  return (
    <div className='container pb-5 mb-6'>
      <HeaderPostal titulo="Añade una foto" dregresar="postal-nombre" dsiguiente=""/>
    <div className="col-lg-12 p-0">
      <div className="row p-0">
        <div className="col-lg-3 p-0">
          <img src={InstaxFoto} alt="" className='float-right' srcset="" />
        </div>
